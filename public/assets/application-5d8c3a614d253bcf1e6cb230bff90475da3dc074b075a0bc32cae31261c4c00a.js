...
%o`, message, error2, detail);
  ...
  var form_controller_default = class extends Controller {
    ...
    required_validation() {
      this.form.querySelectorAll(".required").forEach((el2) => {
        if (el2) {
          if (["INPUT"].includes(el2.tagName)) {
            el2.addEventListener("input", this._form_validation);
          }
          if (el2.type === "hidden") {
            el2.addEventListener("change", this._form_validation);
          }
        }
      });
      this.form.querySelectorAll(".phone-number").forEach((el2) => {
        if (el2) {
          if (!el2.className.includes("required")) {
            el2.addEventListener("input", this._form_validation);
          }
        }
      });
      this.form.querySelectorAll(".email").forEach((el2) => {
        if (el2) {
          if (!el2.className.includes("required")) {
            el2.addEventListener("input", this._form_validation);
          }
      ...
      this.form.querySelectorAll(".employer").forEach((el2) => {
        if (el2) {
          if (!el2.className.includes("required")) {
            el2.addEventListener("input", this._form_validation);
          }
      ...
      this.form.querySelectorAll(".start_date").forEach((el2) => {
        if (el2) {
          if (!el2.className.includes("required")) {
            el2.addEventListener("input", this._form_validation);
          }
      ...
      this.form.querySelectorAll(".emplyment_end_date").forEach((el2) => {
        if (el2) {
          if (!el2.className.includes("required")) {
            el2.addEventListener("input", this._form_validation);
          }
    ...
    // enable_first_name_validation() {
    //   if (this.form.querySelector('.first_name')) {
    //     let disabled = false;
    //     this.form.querySelector('.first_name').addEventListener('input', function() { 
    ...
    _form_validation(e) {
      ...
      this.form.querySelectorAll(".required").forEach((el2) => {
        if (["INPUT"].includes(el2.tagName)) {
          if (el2.tagName === "INPUT") {
            if (this.form[el2.name].value === null || this.form[el2.name].value === "") {
              disabled = true;
              return;
            }
          } else {
            const input_value = el2.value.trim();
      ...
      this.form.querySelectorAll(".email").forEach((el2) => {
        if (el2.className.includes("hidden")) {
          return;
        }
        if (["INPUT"].includes(el2.tagName) && el2.value.length > 0) {
          if (!_is_valid_email(el2.value)) {
            disabled = true;
            return;
          }
        }
      });
      this.form.querySelectorAll(".require-form-validation").forEach((el2) => {
        el2.disabled = disabled;
        if (el2.disabled == false) {
          el2.classList.remove("bg-gray-300");
          el2.classList.add("bg-blue-600");
          el2.classList.add("text-white");
        } else if (el2.disabled == true) {
          el2.classList.remove("bg-blue-600");
          el2.classList.remove("text-white");
          el2.classList.add("bg-gray-300");
        }
      });
    }
  };
