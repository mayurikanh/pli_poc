...
%o`, message, error2, detail);
  ...
  var form_controller_default = class extends Controller {
    ...
    enable_required_validation() {
      ...
      const phone_number = this.form.querySelector(".phone-number");
      if (phone_number) {
      ...
      const employer = this.form.querySelector(".employer");
      if (employer) {
        if (!employer.className.includes("required")) {
          employer.addEventListener("input", this._form_validation);
        }
      }
      const employer_start_date = this.form.querySelector(".start_date");
      ...
      const employer_end_date = this.form.querySelector(".emplyment_end_date");
