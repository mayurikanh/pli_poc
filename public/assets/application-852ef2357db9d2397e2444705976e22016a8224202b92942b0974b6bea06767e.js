...
%o`, message, error2, detail);
  ...
  var form_controller_default = class extends Controller {
    ...
    enable_required_validator() {
      ...
      if (this.form.querySelectorAll(".phone-number")) {
        if (!phone_number.className.includes("required")) {
          phone_number.addEventListener("input", this._form_validator_by_required);
        }
      }
      const email = this.form.querySelector(".email");
      if (email) {
        if (!email.className.includes("required")) {
          email.addEventListener("input", this._form_validator_by_required);
        }
      }
    ...
    //     }
    //     if (el.type === 'hidden') {
    //       el.removeEventListener('change', this._form_validator_by_required);
    //     }
    //   })
