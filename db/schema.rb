...
ActiveRecord::Schema[7.0].define(version: 20_230_706_145_754) do
  create_table 'employments', charset: 'utf8mb4', collation: 'utf8mb4_0900_ai_ci', force: :cascade do |t|
    t.string 'employer'
    t.date 'start_date'
    t.date 'emplyment_end_date'
    t.bigint 'personal_id', null: false
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.index ['personal_id'], name: 'index_employments_on_personal_id'
  end
  ...
  add_foreign_key 'employments', 'personals'
end
